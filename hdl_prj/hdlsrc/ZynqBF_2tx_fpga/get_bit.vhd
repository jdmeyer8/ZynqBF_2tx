-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\ZynqBF_2tx_fpga\get_bit.vhd
...
ARCHITECTURE rtl OF get_bit IS
...
BEGIN
  ...
  get_bit_1_output : PROCESS (ind_unsigned, u_unsigned)
