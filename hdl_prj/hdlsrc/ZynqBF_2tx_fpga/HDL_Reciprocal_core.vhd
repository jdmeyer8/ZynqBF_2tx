-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\ZynqBF_2tx_fpga\HDL_Reciprocal_core.vhd
...
END HDL_Reciprocal_core;


ARCHITECTURE rtl OF HDL_Reciprocal_core IS
