-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\ZynqBF_2tx_fpga\ram_rd_counter.vhd
...
ARCHITECTURE rtl OF ram_rd_counter IS

  -- Component Declarations
  COMPONENT select_inputs
  ...
  FOR ALL : select_inputs
    USE ENTITY work.select_inputs(rtl);
