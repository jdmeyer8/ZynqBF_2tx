-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\ZynqBF_2tx_fpga\in_fifo.vhd
...
ARCHITECTURE rtl OF in_fifo IS
  ...
  FOR ALL : rx_q_fifo
    USE ENTITY work.rx_q_fifo(rtl);

  FOR ALL : rx_i_fifo
    USE ENTITY work.rx_i_fifo(rtl);
