-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\ZynqBF_2tx_fpga\ch_est.vhd
...
ARCHITECTURE rtl OF ch_est IS
  ...
  FOR ALL : Detect_Change
    USE ENTITY work.Detect_Change(rtl);

  FOR ALL : select_inputs_block
    USE ENTITY work.select_inputs_block(rtl);

  FOR ALL : calc_inverse
    USE ENTITY work.calc_inverse(rtl);

  FOR ALL : local_fsm
    USE ENTITY work.local_fsm(rtl);

  FOR ALL : update_csi
    USE ENTITY work.update_csi(rtl);
...
BEGIN
  ...
  u_select_inputs : select_inputs_block
