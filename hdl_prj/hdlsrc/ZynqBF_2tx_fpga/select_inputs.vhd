-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\ZynqBF_2tx_fpga\select_inputs.vhd
...
ARCHITECTURE rtl OF select_inputs IS
...
BEGIN
  ...
  select_inputs_1_output : PROCESS (en1, en2, in1_unsigned, in2_unsigned)
  BEGIN
    ...
    ELSE 
      y_tmp <= to_unsigned(16#0000#, 15);
    END IF;
  END PROCESS select_inputs_1_output;
