-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\ZynqBF_2tx_fpga\peakdetect_ch2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: peakdetect_ch2
-- Source Path: ZynqBF_2tx_fpga/channel_estimator/peakdetect_ch2
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF peakdetect_ch2 IS

  -- Component Declarations
  COMPONENT correlator2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : correlator2
    USE ENTITY work.correlator2(rtl);

  FOR ALL : peak_fsm_block
    USE ENTITY work.peak_fsm_block(rtl);

  FOR ALL : running_max_block
    USE ENTITY work.running_max_block(rtl);

  FOR ALL : store_index_block
    USE ENTITY work.store_index_block(rtl);
  ...
  SIGNAL correlator2_out2                 : std_logic;
  SIGNAL correlator2_out3                 : std_logic;
...
BEGIN
  u_correlator2 : correlator2
    PORT MAP( clk => clk,
              ...
              dval => correlator2_out2,
              step => correlator2_out3
              );

  u_peak_fsm : peak_fsm_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_running_max : running_max_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_store_index : store_index_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  Logical_Operator5_out1 <= correlator2_out3 AND peak_fsm_out1;
  ...
  Logical_Operator7_out1 <= correlator2_out3 AND Compare_To_Constant1_out1;
  ...
  Logical_Operator2_out1 <= correlator2_out3 AND Logical_Operator3_out1;
