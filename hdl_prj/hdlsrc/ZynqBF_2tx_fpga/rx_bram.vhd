-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\ZynqBF_2tx_fpga\rx_bram.vhd
...
ARCHITECTURE rtl OF rx_bram IS
...
BEGIN
  u_rx_ram_i : SimpleDualPortRAM_generic
  ...
  u_rx_ram_q : SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 15,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
