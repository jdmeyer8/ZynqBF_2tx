-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\ZynqBF_2tx_fpga\calc_inverse.vhd
...
ARCHITECTURE rtl OF calc_inverse IS

  -- Component Declarations
  COMPONENT HDL_Reciprocal
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          din                             :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En16
  ...
  FOR ALL : HDL_Reciprocal
    USE ENTITY work.HDL_Reciprocal(rtl);
...
BEGIN
  u_HDL_Reciprocal : HDL_Reciprocal
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              din => din,  -- sfix32_En16
