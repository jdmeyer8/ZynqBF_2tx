-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\ZynqBF_2tx_fpga\correlator1.vhd
...
-- 
-- Module: correlator1
-- Source Path: ZynqBF_2tx_fpga/channel_estimator/peakdetect_ch1/correlator1
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF correlator1 IS
  ...
  FOR ALL : data_in
    USE ENTITY work.data_in(rtl);

  FOR ALL : correlation_config
    USE ENTITY work.correlation_config(rtl);

  FOR ALL : rx_ram_i
    USE ENTITY work.rx_ram_i(rtl);

  FOR ALL : gold_sequences
    USE ENTITY work.gold_sequences(rtl);
  ...
  FOR ALL : correlator_en
    USE ENTITY work.correlator_en(rtl);
...
BEGIN
  ...
  u_correlation_config : correlation_config
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              rst => rst,
  ...
  u_gold_sequences : gold_sequences
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              addr => gs_addr,  -- ufix6
