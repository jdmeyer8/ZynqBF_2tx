-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\ZynqBF_2tx_fpga\ram_counter.vhd
...
ARCHITECTURE rtl OF ram_counter IS
  ...
  SIGNAL ram_counter_1                    : unsigned(15 DOWNTO 0);  -- uint16
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        ram_counter_1 <= to_unsigned(16#0000#, 16);
      ELSIF enb = '1' THEN
        IF Delay4_out1 = '1' THEN 
          ram_counter_1 <= to_unsigned(16#0000#, 16);
        ELSIF Logical_Operator_out1 = '1' THEN 
          ram_counter_1 <= ram_counter_1 + HDL_Counter_count_step;
        END IF;
      END IF;
    END IF;
  ...
  Compare_To_Constant_out1 <= '1' WHEN ram_counter_1 > to_unsigned(16#0000#, 16) ELSE
      '0';
