-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\ZynqBF_2tx_fpga\peakdetect_ch1.vhd
...
ARCHITECTURE rtl OF peakdetect_ch1 IS

  -- Component Declarations
  COMPONENT correlator1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : correlator1
    USE ENTITY work.correlator1(rtl);

  FOR ALL : peak_fsm
    USE ENTITY work.peak_fsm(rtl);

  FOR ALL : running_max
    USE ENTITY work.running_max(rtl);

  FOR ALL : store_index
    USE ENTITY work.store_index(rtl);
