...
if strcmp(computer, 'PCWIN64')
    ...
    toload = '.\data\GoldSequences_4k.mat';
else
    fname1 = './data/GoldSeqConsts1.vhd';
    fname2 = './data/GoldSeqConsts2.vhd';
    toload = './data/GoldSequences_4k.mat';
...
load(toload);
gs1i = fi(gs1_i, 1, 16, 15);
gs1q = fi(gs1_q, 1, 16, 15);
gs2i = fi(gs2_i, 1, 16, 15);
gs2q = fi(gs2_q, 1, 16, 15);
...
for i = 1:64
    fprintf(fid1, ['constant lut_gs1i_data_' sprintf('%d', i) ' : vector_of_signed16(0 to 63) := \n']);
    fprintf(fid2, ['constant lut_gs2i_data_' sprintf('%d', i) ' : vector_of_signed16(0 to 63) := \n']);
    for j = i:64:4096
        if (j < 65)
